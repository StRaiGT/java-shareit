...
public class UserControllerTest {
    ...
    @Test
    public void shouldThrowExceptionIfCreateUserWithExistedEmail() {
    ...
    @Test
    public void shouldGetAllUsersIfEmpty() {
        List<UserDto> usersFromController = userController.getAllUsers();
    ...
    @Test
    public void shouldThrowExceptionIfGetUserByIdNotFound() {
    ...
    @Test
    public void shouldThrowExceptionIfPatchUserExistedEmail() {
        UserDto userDto1 = UserDto.builder()
                .id(1L)
                .name("Test user 1")
                .email("tester1@yandex.ru")
