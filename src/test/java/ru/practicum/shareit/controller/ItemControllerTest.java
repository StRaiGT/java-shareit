...
public class ItemControllerTest {
    ...
    @Test
    public void shouldThrowExceptionIfCreateItemOwnerIdNotFound() {
        ItemDto itemDto = ItemDto.builder()
                .id(1L)
                .name("Test item")
                .description("Test item description")
    ...
    @Test
    public void shouldGetItemsByOwner() {
    ...
    @Test
    public void shouldGetItemsByOwnerIfEmpty() {
        UserDto userDto = UserDto.builder()
                .id(1L)
                .name("Test user")
                .email("tester@yandex.ru")
    ...
    @Test
    public void shouldThrowExceptionIfGetItemByIdNotFound() {
    ...
    @Test
    public void shouldThrowExceptionIfPatchItemOwnerIdNotFound() {
        UserDto userDto = UserDto.builder()
                .id(1L)
                .name("Test user")
                .email("tester@yandex.ru")
    ...
    @Test
    public void shouldThrowExceptionIfPatchItemOwnerIdForbidden() {
        UserDto userDto1 = UserDto.builder()
                .id(1L)
                .name("Test user 1")
                .email("tester1@yandex.ru")
    ...
    @Test
    public void shouldDeleteItemByIdNotFound() {
        UserDto userDto = UserDto.builder()
                .id(1L)
                .name("Test user")
                .email("tester@yandex.ru")
    ...
    @Test
    public void shouldSearchByEmpty() {
        UserDto userDto = UserDto.builder()
                .id(1L)
                .name("Test user")
                .email("tester@yandex.ru")
